# 2 Freq generator by DAC-DMA with TIM6, then HRTIM will trigger ADC by Regular and Injected conversion then ADC Interrupt after ADC conversion and output data to DAC
